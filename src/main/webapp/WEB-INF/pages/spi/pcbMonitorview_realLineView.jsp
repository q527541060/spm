			...
			<div class="row" style="text-align: left;margin-top: -5px">
				<div class="col-md-14" >
                        <ol class="breadcrumb" >
                            ...
                            <li class="active" ><spring:message code="line.spi"></spring:message><%--<a  data-toggle="tooltip" data-placement="bottom" title="点击切换至aoi" href="${basePath}/aStatus/pcbMonitorview_realLineView">spi</a>--%></li>
