    ...
    <nav>
        ...
        <div class="row">
            <div class="col-md-14">
                ...
                <input id="aoiMode" value="${aoiMode}" type="hidden">
            </div>
        </div>
        <div class="row">
...
<script type="text/javascript">
    ...
    function InitMainTable () {
        $('#table-list').bootstrapTable({
            url: '${basePath}/aStatus/historicalMonitorJson_aoi'+
                "?lineNo="+lineNo+"&inspectStartTime="+dStart+
                "&inspectEndTime="+dEnd+"&aoiMode="+aoiMode,                    //请求后台的URL（*）
            dataType:"json",
            method: 'GET',                      //请求方式（*）
    ...
    function refreshMainTable(){
        ...
        var opt = {
            url:'${basePath}/sStatus/historicalMonitorJson'+
                "?lineNo="+lineNo+"&inspectStartTime="+dStart+
                "&inspectEndTime="+dEnd+"&aoiMode="+aoiMode,
            silent: true,
            query:{
                type:1,
                level:2
