...
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 1, 'boardMachineTimeLimit', '5', '2020-07-24 17:09:50', '看板实时刷新(小时单位)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=1);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 2, 'FPY', '1', '2020-07-17 18:19:31', '看板是否需要FPY图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=2);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 3, 'CPK', '1', '2020-07-16 17:40:35', '看板是否需要CPK图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=3);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 4, 'Product', '1', '2020-07-17 18:19:25', '看板是否需要Product图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=4);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 5, 'DefaultTop5', '1', '2020-07-16 17:42:31', '看板是否需要top5图'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=5);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 6, 'defaultType', '1;2;3;4;5', '2020-07-24 17:10:15', 'top5设置'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=6);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 7, 'boardMachineRefreshTime', '4', '2020-07-17 18:20:45', '看板实时刷新间隔(秒单位)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=7);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 8, 'autoDelete', '0', '2020-07-17 10:20:53', '自动删除'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=8);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 9, 'autoDeleteDays', '35', '2020-07-24 17:10:04', '保存数据天数'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=9);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 10, 'standCPK', '1', '2020-07-24 17:10:04', 'CPK设置标准值'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=10);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 11, 'Frequency-start', '8', '2020-07-24 17:10:04', '班次设置值(例如早上八点:8   24小时制)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=11);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 12, 'autoDelete-MaxDays', '365', '2020-07-24 17:10:04', '自动删除最大上限设置天数(一般不设置,如果需要删除天数大于365天请修改天数 例如500天 500)'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=12);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 13, 'hChartColor', '0', '2020-07-24 17:10:04', '选择chart柱形图图表主题皮肤'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=13);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 14, 'backgroundColor', '2', '2020-07-24 17:10:04', '选择spc系统背景皮肤'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=14);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 15, 'passPcbYeild', '85', '2020-07-24 17:10:04', '看板直通率标准设定值 例如85% 85'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=15);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 16, 'boardView-chartMove', '0', '2020-07-24 17:10:04', '看板动画渲染开关'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=16);
INSERT INTO `db_spm210001`.`s_defaultSetting`(id,settingName,settingValue,updateTime,remark) SELECT 17, 'showPad2DImageMode', '0', '2020-07-24 17:10:04', '选择查看缺陷图片方式'FROM DUAL WHERE NOT EXISTS ( SELECT * FROM `db_spm210001`.s_defaultSetting where id=17);
...
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_2`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_2_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_2_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_3`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_3_pcb_pcbidLine`(`pcbidLine`) USING BTREE,
  CONSTRAINT `fore_pad_3_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_4`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_4_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_4_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_5`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_5_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_5_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_6`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_6_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_6_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_7`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_7_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_7_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_8`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_8_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_8_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_9`  (
                                                       `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                       `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                       `padIndex` bigint(20) NULL DEFAULT NULL,
                                                       ...
                                                       `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                       PRIMARY KEY (`id`) USING BTREE,
                                                       INDEX `fore_pad_9_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_9_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_10`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_10_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_10_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_11`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_11_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_11_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_12`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_12_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_12_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_13`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_13_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_13_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_14`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_14_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_14_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_15`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_15_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_15_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_16`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_16_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_16_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_17`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_17_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_17_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_18`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_18_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_18_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_19`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_19_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_19_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_20`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_20_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_20_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_21`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_21_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_21_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_22`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_22_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_22_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_23`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_23_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_23_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_24`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_24_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_24_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_25`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_25_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_25_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_26`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_26_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_26_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_27`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_27_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_27_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_28`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_28_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_28_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_29`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_29_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_29_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_30`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_30_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_30_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE

) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '焊盘' ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`s_pad_31`  (
                                                        `id` bigint(255)  NOT NULL AUTO_INCREMENT,
                                                        `padId` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        `pcbidLine` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
                                                        `padIndex` bigint(20) NULL DEFAULT NULL,
                                                        ...
                                                        `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                        PRIMARY KEY (`id`) USING BTREE,
                                                        INDEX `fore_pad_31_pcb_pcbidLine`(`pcbidLine`) USING BTREE
  #,CONSTRAINT `fore_pad_31_pcb_pcbidLine` FOREIGN KEY (`pcbidLine`) REFERENCES `s_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_2`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent2_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent2_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_3`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent3_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent3_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_4`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent4_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent4_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_5`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent5_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent5_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_6`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent6_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent6_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_7`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent7_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent7_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_8`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent8_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent8_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_9`  (
                                                             `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                             `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             `aoiMode` int(1) NULL DEFAULT NULL,
                                                             `arrayIndex` int(5) NULL DEFAULT NULL,
                                                             ...
                                                             `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                             PRIMARY KEY (`id`) USING BTREE,
                                                             INDEX `FK_Reference_acomponent9_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                             CONSTRAINT `FK_Reference_acomponent9_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_10`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent10_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent10_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_11`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent11_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent11_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_12`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent12_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent12_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_13`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent13_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent13_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_14`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent14_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent14_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_15`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent15_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent15_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_16`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent16_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent16_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_17`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent17_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent17_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_18`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent18_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent18_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_19`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent19_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent19_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_20`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent20_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent20_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_21`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent21_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent21_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_22`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent22_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent22_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_23`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent23_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent23_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_24`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent24_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent24_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_25`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent25_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent25_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_26`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent26_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent26_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_27`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent27_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent27_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_28`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent28_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent28_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_29`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent29_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent29_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_30`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent30_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent30_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_31`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent31_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent31_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
CREATE TABLE IF NOT EXISTS `db_spm210001`.`a_component_32`  (
                                                              `id` bigint(20) NOT NULL AUTO_INCREMENT,
                                                              `pcbIdLine` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              `aoiMode` int(1) NULL DEFAULT NULL,
                                                              `arrayIndex` int(5) NULL DEFAULT NULL,
                                                              ...
                                                              `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
                                                              PRIMARY KEY (`id`) USING BTREE,
                                                              INDEX `FK_Reference_acomponent32_pcbIdLine_apcb`(`pcbIdLine`) USING BTREE,
                                                              CONSTRAINT `FK_Reference_acomponent32_pcbIdLine_apcb` FOREIGN KEY (`pcbIdLine`) REFERENCES `db_spm210001`.`a_pcb` (`pcbIdLine`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
